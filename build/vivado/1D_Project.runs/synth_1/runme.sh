...
HD_PWD='C:/Users/Giant/Desktop/fpga-game/build/vivado/1D_Project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log boolean.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source boolean.tcl
